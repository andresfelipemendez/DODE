...
namespace ImGui
{
    ...
    // - You are calling ImGui functions after ImGui::EndFrame()/ImGui::Present() and before the next ImGui::NewFrame(), which is also illegal.
    ...
    // Present helpers (those functions don't access any ImGui state!)
