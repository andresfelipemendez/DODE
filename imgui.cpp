...
/*
 ...
 - Dear ImGui never touches or knows about your GPU state. The only function that knows about GPU is the draw function that you provide.
   ...
   phases of your own application. All rendering information are stored into command-lists that you will retrieve after calling ImGui::Present().
 ...
 The sub-folders in examples/ contains examples applications following this structure.
     ...
     while (true)
     {
         ...
         // Present dear imgui into screen
         ImGui::Present();
 ...
 EXHIBIT 2: IMPLEMENTING CUSTOM BINDING / CUSTOM ENGINE
     ...
     while (true)
     {
        ...
        // Present dear imgui, swap buffers
        // (You want to try calling EndFrame/Present as late as you can, to be able to use Dear ImGui in your own game rendering code)
        ImGui::EndFrame();
        ImGui::Present();
       ...
       for (int n = 0; n < draw_data->CmdListsCount; n++)
       {
          ...
          for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
          {
             ...
             else
             {
                 ...
                 // Present 'pcmd->ElemCount/3' indexed triangles.
 ...
 - 2018/02/16 (1.60) - obsoleted the io.RenderDrawListsFn callback, you can call your graphics engine render function after ImGui::Present(). Use ImGui::GetDrawData() to retrieve the ImDrawData* to display.
...
// Present a rectangle shaped with optional rounding and borders
...
// Same value as passed to the old io.RenderDrawListsFn function. Valid after Present() and until the next call to NewFrame()
...
void ImGui::NewFrame()
{
    ...
    // But in order to allow the user to call NewFrame() multiple times without calling Present(), we are doing an explicit clear.
...
// This is normally called by Present(). You may want to call it directly if you want to avoid calling Present() but the gain will be very minimal.
void ImGui::EndFrame()
{
    ImGuiContext& g = *GImGui;
...
void ImGui::Render()
{
    ...
    // (Legacy) Call the Present callback function. The current prefer way is to let the user retrieve GetDrawData() and call the render function themselves.
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
...
void ImGui::RenderWindowDecorations(ImGuiWindow* window, const ImRect& title_bar_rect, bool title_bar_is_highlight, int resize_grip_count, const ImU32 resize_grip_col[4], float resize_grip_draw_size)
{
    ...
    else
    {
        ...
        // Present resize grips (after their input handling so we don't have a frame of latency)
...
// Present title text, collapse button, close button
...
bool ImGui::Begin(const char* name, bool* p_open, ImGuiWindowFlags flags)
{
    ...
    IM_ASSERT(g.WithinFrameScope);                  // Forgot to call ImGui::NewFrame()
    IM_ASSERT(g.FrameCountEnded != g.FrameCount);   // Called ImGui::Present() or ImGui::EndFrame() and haven't called ImGui::NewFrame() again yet
...
static void ImGui::ErrorCheckNewFrameSanityChecks()
{
    ...
    IM_ASSERT((g.FrameCount == 0 || g.FrameCountEnded == g.FrameCount)  && "Forgot to call Present() or EndFrame() at the end of the previous frame?");
...
void ImGui::ShowMetricsWindow(bool* p_open)
{
    ...
    struct Funcs
    {
        ...
        static void NodeDrawCmdShowMeshAndBoundingBox(ImGuiWindow* window, const ImDrawList* draw_list, const ImDrawCmd* draw_cmd, int elem_offset, bool show_mesh, bool show_aabb)
        {
            ...
            ImDrawList* fg_draw_list = GetForegroundDrawList(window); // Present additional visuals into the top-most draw list
